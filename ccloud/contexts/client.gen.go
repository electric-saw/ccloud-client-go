...
func (r ListContextsResponse) GetApplicationvndSchemaregistryJSONQs09200() *[]string {
	return r.ApplicationvndSchemaregistryJSONQs09200
}
func (r ListContextsResponse) GetApplicationvndSchemaregistryV1JSON200() *[]string {
	return r.ApplicationvndSchemaregistryV1JSON200
}
func (r ListContextsResponse) GetJSON400() *SchemaregistryV1BadRequestError {
	return r.JSON400
}
func (r ListContextsResponse) GetJSON401() *SchemaregistryV1UnauthorizedError {
	return r.JSON401
}
func (r ListContextsResponse) GetJSON403() *SchemaregistryV1ForbiddenError {
	return r.JSON403
}
func (r ListContextsResponse) GetApplicationjsonQs05500() *ErrorMessage {
	return r.ApplicationjsonQs05500
}
func (r ListContextsResponse) GetApplicationvndSchemaregistryJSONQs09500() *ErrorMessage {
	return r.ApplicationvndSchemaregistryJSONQs09500
}
func (r ListContextsResponse) GetApplicationvndSchemaregistryV1JSON500() *ErrorMessage {
	return r.ApplicationvndSchemaregistryV1JSON500
}
func (r ListContextsResponse) GetBody() []byte {
	return r.Body
}
