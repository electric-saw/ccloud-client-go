...
func decodeGetFcpmV2OrgComputePoolConfigResponse(resp *http.Response) (res GetFcpmV2OrgComputePoolConfigRes, _ error) {
	...
	case 200:
		...
		case ct == "application/json":
			...
			var response GetFcpmV2OrgComputePoolConfigOK
			if err := func() error {
			...
			var wrapper GetFcpmV2OrgComputePoolConfigOKHeaders
...
func decodeUpdateFcpmV2OrgComputePoolConfigResponse(resp *http.Response) (res UpdateFcpmV2OrgComputePoolConfigRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response UpdateFcpmV2OrgComputePoolConfigOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
			...
			var wrapper UpdateFcpmV2OrgComputePoolConfigOKHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "X-RateLimit-Limit" header.
			{
