...
func decodeListContextsResponse(resp *http.Response) (res ListContextsRes, _ error) {
	...
	case 200:
		...
		case ct == "application/json":
			...
			var response ListContextsOKApplicationJSON
			if err := func() error {
		...
		case ct == "application/vnd.schemaregistry+json":
			...
			var response ListContextsOKApplicationVndSchemaregistryJSON
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
		...
		case ct == "application/vnd.schemaregistry.v1+json":
			...
			var response ListContextsOKApplicationVndSchemaregistryV1JSON
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 400:
		...
		case ct == "application/json":
			...
			var response ListContextsBadRequest
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 401:
		...
		case ct == "application/json":
			...
			var response ListContextsUnauthorized
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 403:
		...
		case ct == "application/json":
			...
			var response ListContextsForbidden
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 500:
		...
		case ct == "application/json":
			...
			var response ListContextsApplicationJSONInternalServerError
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
		...
		case ct == "application/vnd.schemaregistry+json":
			...
			var response ListContextsApplicationVndSchemaregistryJSONInternalServerError
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
		...
		case ct == "application/vnd.schemaregistry.v1+json":
			...
			var response ListContextsApplicationVndSchemaregistryV1JSONInternalServerError
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
