...
func (c *Client) PresignedUploadUrlConnectV1PresignedUrlWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PresignedUploadUrlConnectV1PresignedUrl(ctx context.Context, body PresignedUploadUrlConnectV1PresignedUrlJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
