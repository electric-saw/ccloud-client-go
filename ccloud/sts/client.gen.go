...
const (
	StsV1TokenExchangeRequestApiVersionStsv1 StsV1TokenExchangeRequestApiVersion = "sts/v1"
)

func (e StsV1TokenExchangeRequestApiVersion) Valid() bool {
	switch e {
	case StsV1TokenExchangeRequestApiVersionStsv1:
		return true
	default:
		return false
	}
...
const (
	StsV1TokenExchangeRequestKindTokenExchangeRequest StsV1TokenExchangeRequestKind = "TokenExchangeRequest"
)

func (e StsV1TokenExchangeRequestKind) Valid() bool {
	switch e {
	case StsV1TokenExchangeRequestKindTokenExchangeRequest:
		return true
	default:
		return false
	}
...
const (
	ExchangeStsV1OauthTokenFormdataBodyApiVersionStsv1 ExchangeStsV1OauthTokenFormdataBodyApiVersion = "sts/v1"
)

func (e ExchangeStsV1OauthTokenFormdataBodyApiVersion) Valid() bool {
	switch e {
	case ExchangeStsV1OauthTokenFormdataBodyApiVersionStsv1:
		return true
	default:
		return false
	}
...
const (
	ExchangeStsV1OauthTokenFormdataBodyKindTokenExchangeRequest ExchangeStsV1OauthTokenFormdataBodyKind = "TokenExchangeRequest"
)

func (e ExchangeStsV1OauthTokenFormdataBodyKind) Valid() bool {
	switch e {
	case ExchangeStsV1OauthTokenFormdataBodyKindTokenExchangeRequest:
		return true
	default:
		return false
	}
...
type StsV1TokenExchangeReply struct {
	// AccessToken An JWT access token, issued by Confluent, in response to the token exchange request.
	// Client application could use the access token to access confluent public api
	AccessToken string `json:"access_token"`

	// ExpiresIn The length of time, in seconds, that the access token is valid.
	ExpiresIn int32 `json:"expires_in"`

	// IssuedTokenType The token type. Always matches the value of requested_token_type from the request.
	IssuedTokenType string `json:"issued_token_type"`

	// TokenType Indicates the token type value. The only type that Confluent supports is Bearer
	TokenType string `json:"token_type"`
}
type StsV1TokenExchangeRequest struct {
	// ApiVersion APIVersion defines the schema version of this representation of a resource.
	ApiVersion *StsV1TokenExchangeRequestApiVersion `json:"api_version,omitempty"`

	// ExpiresIn The amount of time, in seconds, between the time when the access token was issued
	// and the time when the access token will expire
	ExpiresIn *int32 `json:"expires_in,omitempty"`

	// GrantType The grant type. Must be urn:ietf:params:oauth:grant-type:token-exchange, which indicates a token exchange.
	GrantType *string `json:"grant_type,omitempty"`

	// Id ID is the "natural identifier" for an object within its scope/namespace; it is normally unique across time but not space. That is, you can assume that the ID will not be reclaimed and reused after an object is deleted ("time"); however, it may collide with IDs for other object `kinds` or objects of the same `kind` within a different scope/namespace ("space").
	Id *string `json:"id,omitempty"`

	// IdentityPoolId Identity pool is a group of external identities that are assigned a certain level of access based on policy
	IdentityPoolId *string `json:"identity_pool_id,omitempty"`

	// Kind Kind defines the object this REST resource represents.
	Kind     *StsV1TokenExchangeRequestKind `json:"kind,omitempty"`
	Metadata *struct {
		// CreatedAt The date and time at which this object was created. It is represented in RFC3339 format and is in UTC.
		CreatedAt *time.Time `json:"created_at,omitempty"`
	...
	// RequestedTokenType An identifier for the type of requested security token.
	// Supported values is urn:ietf:params:oauth:token-type:access_token.
	RequestedTokenType *string `json:"requested_token_type,omitempty"`

	// SubjectToken Confluent Cloud only accepts JSON Web Token (JWT) access tokens from customer identity provider
	SubjectToken *string `json:"subject_token,omitempty"`

	// SubjectTokenType An identifier for the type of requested security token. Supported values
	// is urn:ietf:params:oauth:token-type:jwt.
	SubjectTokenType *string `json:"subject_token_type,omitempty"`
}
type StsV1TokenExchangeRequestApiVersion string
type StsV1TokenExchangeRequestKind string
...
type ExchangeStsV1OauthTokenFormdataBody struct {
	// ApiVersion APIVersion defines the schema version of this representation of a resource.
	ApiVersion *ExchangeStsV1OauthTokenFormdataBodyApiVersion `form:"api_version,omitempty" json:"api_version,omitempty"`
	...
	// IdentityPoolId Identity pool is a group of external identities that are assigned a certain level of access based on policy
	IdentityPoolId string `form:"identity_pool_id" json:"identity_pool_id"`

	// Kind Kind defines the object this REST resource represents.
	Kind     *ExchangeStsV1OauthTokenFormdataBodyKind `form:"kind,omitempty" json:"kind,omitempty"`
	Metadata *struct {
		// CreatedAt The date and time at which this object was created. It is represented in RFC3339 format and is in UTC.
		CreatedAt *time.Time `json:"created_at,omitempty"`
		...
		// UpdatedAt The date and time at which this object was last updated. It is represented in RFC3339 format and is in UTC.
		UpdatedAt *time.Time `json:"updated_at,omitempty"`
	} `form:"metadata,omitempty" json:"metadata,omitempty"`
...
type ExchangeStsV1OauthTokenFormdataBodyApiVersion string
type ExchangeStsV1OauthTokenFormdataBodyKind string
type ExchangeStsV1OauthTokenFormdataRequestBody ExchangeStsV1OauthTokenFormdataBody
...
func (c *Client) ExchangeStsV1OauthTokenWithFormdataBody(ctx context.Context, body ExchangeStsV1OauthTokenFormdataRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func NewExchangeStsV1OauthTokenRequestWithFormdataBody(server string, body ExchangeStsV1OauthTokenFormdataRequestBody) (*http.Request, error) {
	...
	return NewExchangeStsV1OauthTokenRequestWithBody(server, "application/x-www-form-urlencoded", bodyReader)
}
...
func (r ExchangeStsV1OauthTokenResponse) GetJSON400() *BadRequestError {
	return r.JSON400
}
func (r ExchangeStsV1OauthTokenResponse) GetJSON500() *DefaultSystemError {
	return r.JSON500
}
func (r ExchangeStsV1OauthTokenResponse) GetBody() []byte {
	return r.Body
}
func (r ExchangeStsV1OauthTokenResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
}
func (r ExchangeStsV1OauthTokenResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
}
func (r ExchangeStsV1OauthTokenResponse) ContentType() string {
	if r.HTTPResponse != nil {
