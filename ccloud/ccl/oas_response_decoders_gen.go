...
func decodeCreateCclV1CustomCodeLoggingResponse(resp *http.Response) (res CreateCclV1CustomCodeLoggingRes, _ error) {
	...
	case 201:
		...
		case ct == "application/json":
			...
			var response CreateCclV1CustomCodeLoggingCreated
			if err := func() error {
			...
			var wrapper CreateCclV1CustomCodeLoggingCreatedHeaders
...
func decodeDeleteCclV1CustomCodeLoggingResponse(resp *http.Response) (res DeleteCclV1CustomCodeLoggingRes, _ error) {
	switch resp.StatusCode {
	case 204:
		// Code 204.
		var wrapper DeleteCclV1CustomCodeLoggingNoContent
		h := uri.NewHeaderDecoder(resp.Header)
		// Parse "X-RateLimit-Limit" header.
		{
			cfg := uri.HeaderParameterDecodingConfig{
...
func decodeGetCclV1CustomCodeLoggingResponse(resp *http.Response) (res GetCclV1CustomCodeLoggingRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response GetCclV1CustomCodeLoggingOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
			...
			var wrapper GetCclV1CustomCodeLoggingOKHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "X-RateLimit-Limit" header.
			{
...
func decodeListCclV1CustomCodeLoggingsResponse(resp *http.Response) (res ListCclV1CustomCodeLoggingsRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response ListCclV1CustomCodeLoggingsOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
			...
			var wrapper ListCclV1CustomCodeLoggingsOKHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "X-RateLimit-Limit" header.
			{
...
func decodeUpdateCclV1CustomCodeLoggingResponse(resp *http.Response) (res UpdateCclV1CustomCodeLoggingRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response UpdateCclV1CustomCodeLoggingOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
			...
			var wrapper UpdateCclV1CustomCodeLoggingOKHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "X-RateLimit-Limit" header.
			{
