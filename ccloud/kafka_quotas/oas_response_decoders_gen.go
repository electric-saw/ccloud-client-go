...
func decodeCreateKafkaQuotasV1ClientQuotaResponse(resp *http.Response) (res CreateKafkaQuotasV1ClientQuotaRes, _ error) {
	...
	case 202:
		...
		case ct == "application/json":
			...
			var response CreateKafkaQuotasV1ClientQuotaAccepted
			if err := func() error {
			...
			var wrapper CreateKafkaQuotasV1ClientQuotaAcceptedHeaders
...
func decodeDeleteKafkaQuotasV1ClientQuotaResponse(resp *http.Response) (res DeleteKafkaQuotasV1ClientQuotaRes, _ error) {
	switch resp.StatusCode {
	case 204:
		// Code 204.
		var wrapper DeleteKafkaQuotasV1ClientQuotaNoContent
		h := uri.NewHeaderDecoder(resp.Header)
		// Parse "X-RateLimit-Limit" header.
		{
			cfg := uri.HeaderParameterDecodingConfig{
...
func decodeGetKafkaQuotasV1ClientQuotaResponse(resp *http.Response) (res GetKafkaQuotasV1ClientQuotaRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response GetKafkaQuotasV1ClientQuotaOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
			...
			var wrapper GetKafkaQuotasV1ClientQuotaOKHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "X-RateLimit-Limit" header.
			{
...
func decodeListKafkaQuotasV1ClientQuotasResponse(resp *http.Response) (res ListKafkaQuotasV1ClientQuotasRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response ListKafkaQuotasV1ClientQuotasOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
			...
			var wrapper ListKafkaQuotasV1ClientQuotasOKHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "X-RateLimit-Limit" header.
			{
...
func decodeUpdateKafkaQuotasV1ClientQuotaResponse(resp *http.Response) (res UpdateKafkaQuotasV1ClientQuotaRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response UpdateKafkaQuotasV1ClientQuotaOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
			...
			var wrapper UpdateKafkaQuotasV1ClientQuotaOKHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "X-RateLimit-Limit" header.
			{
