...
func decodeListEndpointV1EndpointsResponse(resp *http.Response) (res ListEndpointV1EndpointsRes, _ error) {
	...
	case 200:
		...
		case ct == "application/json":
			...
			var response ListEndpointV1EndpointsOK
			if err := func() error {
			...
			var wrapper ListEndpointV1EndpointsOKHeaders
