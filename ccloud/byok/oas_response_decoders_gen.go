...
func decodeCreateByokV1KeyResponse(resp *http.Response) (res CreateByokV1KeyRes, _ error) {
	...
	case 201:
		...
		case ct == "application/json":
			...
			var response CreateByokV1KeyCreated
			if err := func() error {
			...
			var wrapper CreateByokV1KeyCreatedHeaders
...
func decodeDeleteByokV1KeyResponse(resp *http.Response) (res DeleteByokV1KeyRes, _ error) {
	switch resp.StatusCode {
	case 204:
		// Code 204.
		var wrapper DeleteByokV1KeyNoContent
		h := uri.NewHeaderDecoder(resp.Header)
		// Parse "X-RateLimit-Limit" header.
		{
			cfg := uri.HeaderParameterDecodingConfig{
...
func decodeGetByokV1KeyResponse(resp *http.Response) (res GetByokV1KeyRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var wrapper GetByokV1KeyOKHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "X-RateLimit-Limit" header.
			{
...
func decodeUpdateByokV1KeyResponse(resp *http.Response) (res UpdateByokV1KeyRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response UpdateByokV1KeyOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
			...
			var wrapper UpdateByokV1KeyOKHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "X-RateLimit-Limit" header.
			{
