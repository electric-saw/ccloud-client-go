...
func (c *Client) GetSchemaOnly1(ctx context.Context, subject string, version string, params *GetSchemaOnly1Params, reqEditors ...RequestEditorFn) (*http.Response, error) {
