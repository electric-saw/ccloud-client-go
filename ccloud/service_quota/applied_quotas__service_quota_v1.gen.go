...
// Tag: Applied Quotas (service-quota/v1)
...
type ListServiceQuotaV1AppliedQuotasParams struct {
	// Scope The applied scope the quota belongs to.
	Scope SearchFilter `form:"scope" json:"scope"`

	// Environment The environment ID the quota is associated with.
	Environment *SearchFilter `form:"environment,omitempty" json:"environment,omitempty"`

	// Network The network ID the quota is associated with.
	Network *SearchFilter `form:"network,omitempty" json:"network,omitempty"`

	// KafkaCluster The kafka cluster ID the quota is associated with.
	KafkaCluster *SearchFilter `form:"kafka_cluster,omitempty" json:"kafka_cluster,omitempty"`

	// Id The id (quota code) that this quota belongs to.
	Id *SearchFilter `form:"id,omitempty" json:"id,omitempty"`
...
type ListServiceQuotaV1AppliedQuotas200JSONResponseBodyApiVersion string
type ListServiceQuotaV1AppliedQuotas200JSONResponseBodyKind string
...
func NewListServiceQuotaV1AppliedQuotasRequest(server string, params *ListServiceQuotaV1AppliedQuotasParams) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/service-quota/v1/applied-quotas")
	if operationPath[0] == '/' {
	...
	if params != nil {
		...
		if params.KafkaCluster != nil {

			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "kafka_cluster", *params.KafkaCluster, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "string", Format: ""}); err != nil {
				return nil, err
			} else {
				for _, qp := range strings.Split(queryFrag, "&") {
					rawQueryFragments = append(rawQueryFragments, qp)
...
func NewGetServiceQuotaV1AppliedQuotaRequest(server string, id string, params *GetServiceQuotaV1AppliedQuotaParams) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/service-quota/v1/applied-quotas/%s", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ListServiceQuotaV1AppliedQuotasResponse200Headers struct {
	XRateLimitLimit     *int
	XRateLimitRemaining *int
	XRateLimitReset     *int
	XRequestId          *string
}
type ListServiceQuotaV1AppliedQuotasResponse400Headers struct {
	XRequestId *string
}
type ListServiceQuotaV1AppliedQuotasResponse401Headers struct {
	WWWAuthenticate *string
	XRequestId      *string
}
type ListServiceQuotaV1AppliedQuotasResponse403Headers struct {
	XRequestId *string
}
type ListServiceQuotaV1AppliedQuotasResponse429Headers struct {
	RetryAfter          *int
	XRateLimitLimit     *int
	XRateLimitRemaining *int
	XRateLimitReset     *int
...
type ListServiceQuotaV1AppliedQuotasResponse500Headers struct {
	XRequestId *string
}
type ListServiceQuotaV1AppliedQuotasResponse struct {
	Body         []byte
	...
	Headers200 *ListServiceQuotaV1AppliedQuotasResponse200Headers
	// Headers400 the parsed response headers for an HTTP 400 response
	Headers400 *ListServiceQuotaV1AppliedQuotasResponse400Headers
	// Headers401 the parsed response headers for an HTTP 401 response
	Headers401 *ListServiceQuotaV1AppliedQuotasResponse401Headers
	// Headers403 the parsed response headers for an HTTP 403 response
	Headers403 *ListServiceQuotaV1AppliedQuotasResponse403Headers
	// Headers429 the parsed response headers for an HTTP 429 response
	Headers429 *ListServiceQuotaV1AppliedQuotasResponse429Headers
	// Headers500 the parsed response headers for an HTTP 500 response
	Headers500 *ListServiceQuotaV1AppliedQuotasResponse500Headers
}
type GetServiceQuotaV1AppliedQuotaResponse200Headers struct {
	XRateLimitLimit     *int
	XRateLimitRemaining *int
	XRateLimitReset     *int
	XRequestId          *string
}
type GetServiceQuotaV1AppliedQuotaResponse400Headers struct {
	XRequestId *string
}
type GetServiceQuotaV1AppliedQuotaResponse401Headers struct {
	WWWAuthenticate *string
	XRequestId      *string
}
type GetServiceQuotaV1AppliedQuotaResponse403Headers struct {
	XRequestId *string
}
type GetServiceQuotaV1AppliedQuotaResponse404Headers struct {
	XRequestId *string
}
type GetServiceQuotaV1AppliedQuotaResponse429Headers struct {
	RetryAfter          *int
	XRateLimitLimit     *int
	XRateLimitRemaining *int
	XRateLimitReset     *int
...
type GetServiceQuotaV1AppliedQuotaResponse500Headers struct {
	XRequestId *string
}
type GetServiceQuotaV1AppliedQuotaResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	// JSON200 the response for an HTTP 200 `application/json` response
	JSON200 *struct {
	...
	JSON500 *DefaultSystemError
	// Headers200 the parsed response headers for an HTTP 200 response
	Headers200 *GetServiceQuotaV1AppliedQuotaResponse200Headers
	// Headers400 the parsed response headers for an HTTP 400 response
	Headers400 *GetServiceQuotaV1AppliedQuotaResponse400Headers
	// Headers401 the parsed response headers for an HTTP 401 response
	Headers401 *GetServiceQuotaV1AppliedQuotaResponse401Headers
	// Headers403 the parsed response headers for an HTTP 403 response
	Headers403 *GetServiceQuotaV1AppliedQuotaResponse403Headers
	// Headers404 the parsed response headers for an HTTP 404 response
	Headers404 *GetServiceQuotaV1AppliedQuotaResponse404Headers
	// Headers429 the parsed response headers for an HTTP 429 response
	Headers429 *GetServiceQuotaV1AppliedQuotaResponse429Headers
	// Headers500 the parsed response headers for an HTTP 500 response
	Headers500 *GetServiceQuotaV1AppliedQuotaResponse500Headers
}
...
func (c *ClientWithResponses) GetServiceQuotaV1AppliedQuotaWithResponse(ctx context.Context, id string, params *GetServiceQuotaV1AppliedQuotaParams, reqEditors ...RequestEditorFn) (*GetServiceQuotaV1AppliedQuotaResponse, error) {
	...
	return ParseGetServiceQuotaV1AppliedQuotaResponse(rsp)
}
func ParseListServiceQuotaV1AppliedQuotasResponse(rsp *http.Response) (*ListServiceQuotaV1AppliedQuotasResponse, error) {
	...
	response := &ListServiceQuotaV1AppliedQuotasResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	case rsp.StatusCode == 200:
		var headers ListServiceQuotaV1AppliedQuotasResponse200Headers
	...
	case rsp.StatusCode == 400:
		var headers ListServiceQuotaV1AppliedQuotasResponse400Headers
		if values := rsp.Header.Values("X-Request-Id"); len(values) > 0 {
			var value string
			if err := runtime.BindStyledParameterWithOptions("simple", "X-Request-Id", values[0], &value, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false, Type: "string", Format: ""}); err != nil {
				return nil, err
	...
	case rsp.StatusCode == 401:
		var headers ListServiceQuotaV1AppliedQuotasResponse401Headers
	...
	case rsp.StatusCode == 403:
		var headers ListServiceQuotaV1AppliedQuotasResponse403Headers
		if values := rsp.Header.Values("X-Request-Id"); len(values) > 0 {
			var value string
			if err := runtime.BindStyledParameterWithOptions("simple", "X-Request-Id", values[0], &value, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false, Type: "string", Format: ""}); err != nil {
				return nil, err
	...
	case rsp.StatusCode == 429:
		var headers ListServiceQuotaV1AppliedQuotasResponse429Headers
	...
	case rsp.StatusCode == 500:
		var headers ListServiceQuotaV1AppliedQuotasResponse500Headers
		if values := rsp.Header.Values("X-Request-Id"); len(values) > 0 {
			var value string
			if err := runtime.BindStyledParameterWithOptions("simple", "X-Request-Id", values[0], &value, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false, Type: "string", Format: ""}); err != nil {
				return nil, err
...
func ParseGetServiceQuotaV1AppliedQuotaResponse(rsp *http.Response) (*GetServiceQuotaV1AppliedQuotaResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetServiceQuotaV1AppliedQuotaResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	switch {
	case rsp.StatusCode == 200:
		var headers GetServiceQuotaV1AppliedQuotaResponse200Headers
		if values := rsp.Header.Values("X-RateLimit-Limit"); len(values) > 0 {
			var value int
			if err := runtime.BindStyledParameterWithOptions("simple", "X-RateLimit-Limit", values[0], &value, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false, Type: "integer", Format: ""}); err != nil {
				return nil, err
		...
		response.Headers200 = &headers
	case rsp.StatusCode == 400:
		var headers GetServiceQuotaV1AppliedQuotaResponse400Headers
		if values := rsp.Header.Values("X-Request-Id"); len(values) > 0 {
			var value string
			if err := runtime.BindStyledParameterWithOptions("simple", "X-Request-Id", values[0], &value, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false, Type: "string", Format: ""}); err != nil {
				return nil, err
		...
		response.Headers400 = &headers
	case rsp.StatusCode == 401:
		var headers GetServiceQuotaV1AppliedQuotaResponse401Headers
		if values := rsp.Header.Values("WWW-Authenticate"); len(values) > 0 {
			var value string
			if err := runtime.BindStyledParameterWithOptions("simple", "WWW-Authenticate", values[0], &value, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false, Type: "string", Format: ""}); err != nil {
				return nil, err
		...
		response.Headers401 = &headers
	case rsp.StatusCode == 403:
		var headers GetServiceQuotaV1AppliedQuotaResponse403Headers
		if values := rsp.Header.Values("X-Request-Id"); len(values) > 0 {
			var value string
			if err := runtime.BindStyledParameterWithOptions("simple", "X-Request-Id", values[0], &value, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false, Type: "string", Format: ""}); err != nil {
				return nil, err
	...
	case rsp.StatusCode == 404:
		var headers GetServiceQuotaV1AppliedQuotaResponse404Headers
		if values := rsp.Header.Values("X-Request-Id"); len(values) > 0 {
			var value string
			if err := runtime.BindStyledParameterWithOptions("simple", "X-Request-Id", values[0], &value, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false, Type: "string", Format: ""}); err != nil {
				return nil, err
	...
	case rsp.StatusCode == 429:
		var headers GetServiceQuotaV1AppliedQuotaResponse429Headers
		if values := rsp.Header.Values("Retry-After"); len(values) > 0 {
			var value int
			if err := runtime.BindStyledParameterWithOptions("simple", "Retry-After", values[0], &value, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false, Type: "integer", Format: ""}); err != nil {
				return nil, err
		...
		response.Headers429 = &headers
	case rsp.StatusCode == 500:
		var headers GetServiceQuotaV1AppliedQuotaResponse500Headers
		if values := rsp.Header.Values("X-Request-Id"); len(values) > 0 {
			var value string
			if err := runtime.BindStyledParameterWithOptions("simple", "X-Request-Id", values[0], &value, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false, Type: "string", Format: ""}); err != nil {
				return nil, err
