...
func decodeCreateRtceV1RtceTopicResponse(resp *http.Response) (res CreateRtceV1RtceTopicRes, _ error) {
	...
	case 202:
		...
		case ct == "application/json":
			...
			var response CreateRtceV1RtceTopicAccepted
			if err := func() error {
			...
			var wrapper CreateRtceV1RtceTopicAcceptedHeaders
...
func decodeDeleteRtceV1RtceTopicResponse(resp *http.Response) (res DeleteRtceV1RtceTopicRes, _ error) {
	switch resp.StatusCode {
	case 204:
		// Code 204.
		var wrapper DeleteRtceV1RtceTopicNoContent
		h := uri.NewHeaderDecoder(resp.Header)
		// Parse "X-RateLimit-Limit" header.
		{
			cfg := uri.HeaderParameterDecodingConfig{
...
func decodeGetRtceV1RtceTopicResponse(resp *http.Response) (res GetRtceV1RtceTopicRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response GetRtceV1RtceTopicOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
			...
			var wrapper GetRtceV1RtceTopicOKHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "X-RateLimit-Limit" header.
			{
...
func decodeListRtceV1RtceTopicsResponse(resp *http.Response) (res ListRtceV1RtceTopicsRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response ListRtceV1RtceTopicsOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
			...
			var wrapper ListRtceV1RtceTopicsOKHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "X-RateLimit-Limit" header.
			{
...
func decodeUpdateRtceV1RtceTopicResponse(resp *http.Response) (res UpdateRtceV1RtceTopicRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response UpdateRtceV1RtceTopicOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
			...
			var wrapper UpdateRtceV1RtceTopicOKHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "X-RateLimit-Limit" header.
			{
