...
func decodeActivateSignupResponse(resp *http.Response) (res ActivateSignupRes, _ error) {
	...
	case 201:
		...
		case ct == "application/json":
			...
			var response PartnerSignupResponse
			if err := func() error {
...
func decodeCreatePartnerV2EntitlementResponse(resp *http.Response) (res CreatePartnerV2EntitlementRes, _ error) {
	switch resp.StatusCode {
	case 201:
		// Code 201.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response CreatePartnerV2EntitlementCreated
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
			...
			var wrapper CreatePartnerV2EntitlementCreatedHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "Location" header.
			{
...
func decodeGetPartnerV2EntitlementResponse(resp *http.Response) (res GetPartnerV2EntitlementRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response GetPartnerV2EntitlementOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
...
func decodeGetPartnerV2OrganizationResponse(resp *http.Response) (res GetPartnerV2OrganizationRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response GetPartnerV2OrganizationOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
