...
func decodeCreateKsqldbcmV2ClusterResponse(resp *http.Response) (res CreateKsqldbcmV2ClusterRes, _ error) {
	...
	case 202:
		...
		case ct == "application/json":
			...
			var response CreateKsqldbcmV2ClusterAccepted
			if err := func() error {
			...
			var wrapper CreateKsqldbcmV2ClusterAcceptedHeaders
...
func decodeDeleteKsqldbcmV2ClusterResponse(resp *http.Response) (res DeleteKsqldbcmV2ClusterRes, _ error) {
	switch resp.StatusCode {
	case 204:
		// Code 204.
		var wrapper DeleteKsqldbcmV2ClusterNoContent
		h := uri.NewHeaderDecoder(resp.Header)
		// Parse "X-RateLimit-Limit" header.
		{
			cfg := uri.HeaderParameterDecodingConfig{
...
func decodeGetKsqldbcmV2ClusterResponse(resp *http.Response) (res GetKsqldbcmV2ClusterRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response GetKsqldbcmV2ClusterOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
			...
			var wrapper GetKsqldbcmV2ClusterOKHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "X-RateLimit-Limit" header.
			{
...
func decodeListKsqldbcmV2ClustersResponse(resp *http.Response) (res ListKsqldbcmV2ClustersRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response ListKsqldbcmV2ClustersOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
			...
			var wrapper ListKsqldbcmV2ClustersOKHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "X-RateLimit-Limit" header.
			{
