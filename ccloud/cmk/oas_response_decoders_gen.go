...
func decodeCreateCmkV2ClusterResponse(resp *http.Response) (res CreateCmkV2ClusterRes, _ error) {
	...
	case 202:
		...
		case ct == "application/json":
			...
			var response CreateCmkV2ClusterAccepted
			if err := func() error {
			...
			var wrapper CreateCmkV2ClusterAcceptedHeaders
...
func decodeDeleteCmkV2ClusterResponse(resp *http.Response) (res DeleteCmkV2ClusterRes, _ error) {
	switch resp.StatusCode {
	case 204:
		// Code 204.
		var wrapper DeleteCmkV2ClusterNoContent
		h := uri.NewHeaderDecoder(resp.Header)
		// Parse "X-RateLimit-Limit" header.
		{
			cfg := uri.HeaderParameterDecodingConfig{
...
func decodeGetCmkV2ClusterResponse(resp *http.Response) (res GetCmkV2ClusterRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response GetCmkV2ClusterOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
			...
			var wrapper GetCmkV2ClusterOKHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "X-RateLimit-Limit" header.
			{
...
func decodeListCmkV2ClustersResponse(resp *http.Response) (res ListCmkV2ClustersRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response ListCmkV2ClustersOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
			...
			var wrapper ListCmkV2ClustersOKHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "X-RateLimit-Limit" header.
			{
...
func decodeUpdateCmkV2ClusterResponse(resp *http.Response) (res UpdateCmkV2ClusterRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response UpdateCmkV2ClusterOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
			...
			var wrapper UpdateCmkV2ClusterOKHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
			// Parse "X-RateLimit-Limit" header.
			{
